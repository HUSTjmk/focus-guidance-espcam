...
private:
...
#else
        ESP_LOGI(TAG, "Using ST7789 LCD driver");
...
#endif
    ESP_LOGI(TAG, "Width: %d, Height: %d", DISPLAY_WIDTH, DISPLAY_HEIGHT);
    ...
    //     offline_word_detect.AddCommand("ni hao le xin", [this](){               
    //     std::thread ([this](){
